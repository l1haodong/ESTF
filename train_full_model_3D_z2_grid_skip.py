...
from datas.train_data_full import TrainData
from configs.config_3D_z2_grid_skip import learning_rate, num_epochs, train_batch_size, val_batch_size\
    , model_save_path, save_freq, device_id, mode, ValData, delta
from util.utils_3D_z2_grid_skip import to_psnr, print_log, validation, adjust_learning_rate, findLastCheckpoint
from model.GDConvNet_3D_z2_grid_skip import L1_Charbonnier_loss, Net
...
def main():
    ...
    # Total_params: 6043271

    # 之前有 batch_size=train_batch_size / device_ids
