...
import torch
from model.GDConvNet_ca import Net
...
net.load_state_dict(torch.load('/data/haodongli/GDConvNet-main/modeldict/poly_ca_2/net_best_weight', map_location='cuda:0'), strict=False)
...
img_out_dir = '/data/haodongli/GDConvNet-main/out/vimeo90K7/gdc/ceshi/'
#img_out_dir = '/data/haodongli/GDConvNet-main/out/vimeo90K7/gdc/ori3/'
...
for batch_id, val_data in enumerate(val_data_loader):
    ...
    with torch.no_grad():
        ...
        #revtrans(oup.cpu()[0]).save(img_out_dir + '/' + str(batch_id) + '.png')
        ...
        print('idx: %d, psnr: %f, ssim: %f, lpips: %f' % (batch_id, oup_psnr[-1], oup_ssim[-1], oup_ssim[-1],)) # lps.item()))
