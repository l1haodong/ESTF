...
from configs.config_3D_z2 import lr_schular, img_save_path, training_schedule
import os
import statistics
import torchvision.transforms as TF
from configs.config_3D_z2 import mean, std
import pytorch_ssim
...
def print_log(epoch, num_epochs, one_epoch_time, train_psnr, oup_pnsr, oup_ssim, mode):
    ...
    # write training log
    with open('./training_log/3D/{}_log.txt'.format(mode), 'a') as f:
        print(
