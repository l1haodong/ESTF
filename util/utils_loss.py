...
from configs.config_loss import lr_schular, img_save_path, training_schedule
import os
import statistics
import torchvision.transforms as TF
from configs.config_loss import mean, std
import pytorch_ssim
...
def print_log(epoch, num_epochs, one_epoch_time, train_psnr, oup_pnsr, oup_ssim, mode):
    ...
    # write training log
    with open('./training_log/loss/{}_log.txt'.format(mode), 'a') as f:
        print(
