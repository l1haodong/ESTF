...
class FeatureExtraction(torch.nn.Module):
    def __init__(self):
        ...
        self.deconv2_1 = nn.ConvTranspose3d(256, 64, kernel_size=(3, 4, 4), stride=(1, 2, 2), padding=(1, 1, 1), bias=if_bias)
...
class Net(nn.Module):
    def __init__(self, nf, growth_rate, mode):
        ...
        if mode == 'poly':
            from model.deformable.deform_conv3D_poly_3D128_z2_grid_skip import DeformConv3d as DCN3D
        elif mode == '3axis':
