...
from configs.config_test import val_data_dir
ImageFile.LOAD_TRUNCATED_IMAGES = True
from util.utils_test import transform

class ValData(data.Dataset):
    def __init__(self, mode='full'):
        super().__init__()
        val_list = val_data_dir + 'sep_testlist.txt'
        # val_list = val_data_dir + 'sep_fast_testset.txt'
        #val_list = val_data_dir + 'sep_medium_testset.txt'
        #val_list = val_data_dir + 'sep_slow_testset.txt'
